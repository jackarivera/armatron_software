...
#define MG8008_SINGLE_TURN_DEG_SCALE_MAX 360
...
#define MG4005_REDUCTION_RATIO 10
...
#define JOINT_5_ANGLE_LIMIT_LOW 0
#define JOINT_5_ANGLE_LIMIT_HIGH 0
#define JOINT_5_NM_TO_IQ_M 0 // [iq/Nm]
#define JOINT_5_NM_TO_IQ_B 0 // [iq]

#define JOINT_6_ANGLE_LIMIT_LOW 0
#define JOINT_6_ANGLE_LIMIT_HIGH 0
#define JOINT_6_NM_TO_IQ_M 0 // [iq/Nm]
#define JOINT_6_NM_TO_IQ_B 0 // [iq]

#define JOINT_7_ANGLE_LIMIT_LOW 0
#define JOINT_7_ANGLE_LIMIT_HIGH 0
